...
import { Box, Button, Heading, Stack, Text, useColorMode } from "@chakra-ui/react";
...
export const Count = ({ count, isConnectWallet, onClick }:{count: number, isConnectWallet: boolean}) => {
